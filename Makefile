...
cicd: ## Add CI/CD services (GitLab + GitLab Runner)
	...
	@echo "   - GitLab: http://$(shell hostname -I | awk '{print $$1}'):8086 (SAFE: avoids LVDA on 8080)"
	@echo "   - SSH Git: ssh://git@$(shell hostname -I | awk '{print $$1}'):2222"
	@echo "   - Initial root password: initialpassword123"
	@echo ""
	@echo "🔧 Next steps:"
	@echo "   1. Access GitLab at http://$(shell hostname -I | awk '{print $$1}'):8086"
...
gitlab-setup: ## Configure GitLab runners (run after GitLab is ready)
	...
	@echo "   http://$(shell hostname -I | awk '{print $$1}'):8086/admin/runners"
	@echo ""
